...
class EntityManager : public EGG::Disposer {
    ...
    void InsertKart(Vec3* position, u32 params, Kart* subject, float radius, float maxSpeed); //80786050
    ...
    void PrepareFromEntity(const Entity& entity, u32 entitiesIsSolidWith); //80786774 for example calling with 0x10 means it'll only be solid with objectKCLs

...
public:
    MiiHeadsModel(u32 r4, MiiDriverModel* driverModel, u32 r6, Mii* mii, u32 r8); //807dbd80
    MiiHeadsModel(u32 r4, MiiDriverModel* driverModel, u32 r6, u32 miiIdx, u32 r8, u32 r9); //807dbe0c
    MiiHeadsModel(u32 r4, MiiDriverModel* driverModel, u32 r6, Mii* mii, u32 r8, u32 r9); //807dbfbc

...
class TwistedWay : public ObjectKCL { //ObjectNum 0x1fe = 510
    ...
    bool IsCollidingNoTerrainInfoNoTriangleCheck(const Vec3& position, const Vec3& prevPosition,
        ...
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xd0 808148a8
    void IsCollidingAddEntryNoTerrainInfoNoTriangleCheck(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xd4 808148ac
    bool IsColliding(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xd8 808148b0
    bool IsCollidingNoTriangleCheck(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override;
    ...
    void IsCollidingNoTerrainInfo(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xf4 80814858
    bool IsCollidingAddEntryNoTerrainInfo(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xf8 8081485c
    void vf_0xfc() override; //0xfc 80814860
    bool IsCollidingAddEntry(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0x100 80814864
    ...
    void IsCollidingImpl(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius); //80815d64

...
class ObjectKCLHolder {
    ...
    void UpdateKCLHandler(float radius, const Vec3& position, KCLTypesBIT bitfield, u32 r6); //8081b7cc  
    ...
    void CheckCollision(float radius, const Vec3& position, const Vec3& lastPosition,

...
class VolcanoPiece : public ObjectExternKCL { //ObjectNum 0x1fc = 508
    ...
    bool IsCollidingNoTerrainInfoNoTriangleCheck(const Vec3& position, const Vec3& prevPosition,
        ...
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xd0 80804f68
    void IsCollidingAddEntryNoTerrainInfoNoTriangleCheck(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xd4 808050ec
    bool IsColliding(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xd8 80805270
    bool IsCollidingNoTriangleCheck(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xdc 808053f4

    void UpdateKCL(const Vec3& position, KCLTypesBitfield accepted, bool isBiggerThanDefaultScale, float radius) override; //0xe0 808044c0
    ...
    void IsCollidingNoTerrainInfo(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xf4 808045ac
    bool IsCollidingAddEntryNoTerrainInfo(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0xf8 80804730
    void vf_0xfc() override; //0xfc 808048b4
    bool IsCollidingAddEntry(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0x100 80804a38
    ...
    bool IsCollidingNoTriangleCheckImpl(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0x148 808199a8
    bool IsCollidingImpl(const Vec3& position, const Vec3& prevPosition,
        KCLTypesBitfield accepted, CollisionInfo* collisionInfo,
        KCLTypeHolder* result, u32 initialTime, float radius) override; //0x14c 80819da0

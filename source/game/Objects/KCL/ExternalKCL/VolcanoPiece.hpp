...
class VolcanoPiece: public ObjectExternKCL { //0x1fc = 508
    explicit VolcanoPiece(const KMP::GOBJHolder& gobjHolder); //80817de8
    ...
    void UpdateKCLHandler(float radius, const Vec3& position, KCLTypesBIT bitfield, u32 r6) override; //0xe0 808044c0

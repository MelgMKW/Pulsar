...
class ObjectHolder {
public:
    static ObjectHolder* sInstance; //809c4330
    ...
    void CreateObject(const KMP::GOBJHolder& gobj); //80821e14 "ObjectGenerator"
    ...
    void CheckCollision(const Kart& kart, ObjectCollisionPolyhedra* collision); //8082ab04

...
public:
    ...
    static bool ComputeRawMii(RawMii& dest, const MiiTexMap& data); //8052758c
    u32 r4;
...
public:
    MiiHeadsModel(u32 r4, ModelDirector* driverModel, u32 r6, Mii *mii, u32 r8); //807dbd80
    MiiHeadsModel(u32 r4, ModelDirector* driverModel, u32 r6, Mii* mii, u32 r8, u32 r9); //807dbe0c

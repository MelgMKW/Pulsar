...
public:
    ...
    void UpdateKCLHandler(float radius, const Vec3& position, KCLTypesBIT bitfield, u32 r6); //8078e4f0
    ...
    nw4r::g3d::ResFile courseBRRES; //course_model.brres
    nw4r::g3d::ResFile courseBRRES2; //vrcorn_model.brres
    void* kclThing;
};

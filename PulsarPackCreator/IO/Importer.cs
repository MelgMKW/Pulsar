...
namespace PulsarPackCreator.IO
{
    class Importer : IOBase
    {
        ...
        {
            PulsarGame.BinaryHeaderV1 header = PulsarGame.BytesToStruct<PulsarGame.BinaryHeaderV1>(raw.ToArray());
            ...
            nint offset = header.offsetToCups + Marshal.OffsetOf(typeof(PulsarGame.CupsHolder), "cups") + Marshal.OffsetOf(typeof(PulsarGame.CupsV1), "cupsArray");
